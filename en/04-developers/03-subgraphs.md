...
At Sofa.org, we support the development of efficient and responsive applications by providing real-time and accurate blockchain data access through the use of The Graph. Subgraphs are a powerful tool that allows us to index data stored on Ethereum and query this data via GraphQL. Here is how you can utilize custom subgraphs for Sofa.org to query related data.

## Accessing Our Subgraph

We have created specific subgraphs for Sofa.org's data. These subgraphs contain various entities indexed from the blockchain, such as transactions, accounts, and specific events related to our DeFi products. You can query data in the subgraph by following these steps:

### Step 1: Find the Endpoint

Locate the GraphQL endpoint URL corresponding to the subgraph you wish to interact with. This typically appears as a web address link. Ensure you are using the most up-to-date endpoint.
...
By following these steps, you can effectively use The Graph to query data on Sofa.org for your development projects. For more information, please refer to our developer documentation and Subgraph related resources.
